...
define('THIMTHUMBURL' , get_template_directory_uri()."/timthumb.php");
...
function wpb_custom_new_menu() {
  register_nav_menus(
    array(
      ...
      'footer-section' => __( 'Footer Section' ),
	 
	  'information-section' => __( 'Information Section' ),
	  'news-list' => __( 'News List' ),
	  'service-section' => __( 'Service Section' ),
	   'footer-bottom' => __( 'Footer Bottom' ),
	   'fleet-section' => __( 'Fleet Section' ),
...
//echo 'Developed by <a href="http://www.fitser.com" target="_blank">Fitser</a></p>';
...
function custom_text_validation_filter( $result, $tag ) {
    ...
    if ( 'user-name' == $tag->name ) {
        ...
        if (!preg_match($re, $_POST['user-name'], $matches)) {
	 ...
	 if ( 'full-name' == $tag->name ) {
        ...
        if (!preg_match($re, $_POST['full-name'], $matches)) {
            $result->invalidate($tag, "This is not a valid name." );
        }
    }
 ...
 <script type="text/javascript">
  jQuery(document).ready(function($) {
   $('#loginform').validate({
    ...
    messages: {
     log: "Please fill the required field",
     pwd: "Please enter a valid password."
    },
	highlight: function(element) {
		$("#user_login-error").css('color', 'red');
        $("#user_pass-error").css('color', 'red');
    },
   });
  });
 </script>
...
function wpse_new_mail_from_name( $old ) {
    return 'RTO Software'; // Edit it with your/company name
}
...
function tutsplus_widgets_init() {
    ...
    register_sidebar( array(
        'name' => __( 'Product Filter', 'tutsplus' ),
        'id' => 'product-filter',
        'description' => __( 'Product Filter', 'tutsplus' ),
...
function disable_new_posts() {
    ...
    //if (isset($_GET['post_type']) && $_GET['post_type'] == 'order-management') {
       // echo '<style type="text/css">
      // .post-type-order-management .page-title-action { display: none !important; }
       // </style>';
   // }
}
